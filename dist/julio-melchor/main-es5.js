...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_community_dashboard_community_dashboard_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/community-dashboard/community-dashboard.component */
    ...
    var routes = [{
      ...
      component: _components_community_dashboard_community_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["CommunityDashboardComponent"]
    }];
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 0,
      consts: [["color", "primary"], ["mat-button", "", "routerLink", "/"], ["mat-button", "", "routerLink", "/about"], ["mat-button", "", "routerLink", "/community-dashboard"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_community_dashboard_community_dashboard_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/community-dashboard/community-dashboard.component */
    "./src/app/components/community-dashboard/community-dashboard.component.ts");
    /* harmony import */
    ...
    "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/progress-spinner.js"); // Import HttpClient Module
    // Routes components
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_9__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_11__["MatCardModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_13__["MatProgressSpinnerModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], _components_about_about_component__WEBPACK_IMPORTED_MODULE_6__["AboutComponent"], _components_community_dashboard_community_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["CommunityDashboardComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_9__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_11__["MatCardModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_13__["MatProgressSpinnerModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsCommunityDashboardCommunityDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CommunityDashboardComponent", function () {
    ...
    function CommunityDashboardComponent_mat_spinner_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-spinner");
      }
    }

    function CommunityDashboardComponent_mat_card_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var CommunityDashboardComponent = /*#__PURE__*/function () {
      function CommunityDashboardComponent(dataService) {
        _classCallCheck(this, CommunityDashboardComponent);
      ...
      _createClass(CommunityDashboardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.dataService.sendGetRequest().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (res) {
            console.log(res);
        ...
        value: function firstPage() {
          ...
          this.products = [];
          this.dataService.sendGetRequestToUrl(this.dataService.first).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (res) {
            console.log(res);
            _this2.products = res.body;
          });
        }
      }, {
        key: "previousPage",
        value: function previousPage() {
          ...
          if (this.dataService.prev !== undefined && this.dataService.prev !== '') {
            this.products = [];
            this.dataService.sendGetRequestToUrl(this.dataService.prev).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (res) {
              console.log(res);
              _this3.products = res.body;
            });
          }
        }
      }, {
        ...
        value: function nextPage() {
          ...
          if (this.dataService.next !== undefined && this.dataService.next !== '') {
            this.products = [];
            this.dataService.sendGetRequestToUrl(this.dataService.next).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (res) {
              console.log(res);
              _this4.products = res.body;
            });
          }
        }
      }, {
        ...
        value: function lastPage() {
          ...
          this.products = [];
          this.dataService.sendGetRequestToUrl(this.dataService.last).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (res) {
            console.log(res);
            _this5.products = res.body;
          });
        }
      }]);
    ...
    CommunityDashboardComponent.ɵfac = function CommunityDashboardComponent_Factory(t) {
      return new (t || CommunityDashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]));
    };

    CommunityDashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CommunityDashboardComponent,
      selectors: [["app-community-dashboard"]],
      decls: 12,
      vars: 2,
      consts: [[2, "padding", "13px"], [4, "ngIf"], ["style", "margin-top:10px;", 4, "ngFor", "ngForOf"], ["mat-button", "", 3, "click"], [2, "margin-top", "10px"], [2, "height", "100%", "width", "100%", 3, "src"], ["mat-button", ""]],
      template: function CommunityDashboardComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommunityDashboardComponent_Template_button_click_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommunityDashboardComponent_Template_button_click_6_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommunityDashboardComponent_Template_button_click_8_listener() {
            return ctx.nextPage();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommunityDashboardComponent_Template_button_click_10_listener() {
            return ctx.lastPage();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CommunityDashboardComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppSharedServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); // imports for error  handle
      ...
      _createClass(DataService, [{
        ...
        value: function sendGetRequest() {
          ...
          return this.httpClient.get(this.REST_API_SERVER, {
            ...
            _this6.parseLinkHeader(res.headers.get('Link'));
          }));
        }
      }, {
        ...
        value: function sendGetRequestToUrl(url) {
          ...
          return this.httpClient.get(url, {
            ...
            _this7.parseLinkHeader(res.headers.get('Link'));
          }));
        }
      }, {
        key: "parseLinkHeader",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Volumes/DOCUMENTOS/JCMP/Repositorio/beaverNet/julio-melchor/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
